...
################################################################################
    ...
    # def p_precond_lst(self, p):
    #     '''precond_lst : literal
    #                    | LPAREN AND_KEY precond_lst RPAREN
    #                    | LPAREN OR_KEY precond_lst RPAREN
    #                    | LPAREN NOT_KEY predicate_def RPAREN
    #                    | LPAREN IMPLY_KEY precond_lst precond_lst RPAREN
    #                    | LPAREN EXISTS_KEY LPAREN typed_variables_lst RPAREN precond_lst
    #                    | LPAREN FORALL_KEY LPAREN typed_variables_lst RPAREN precond_lst'''
    #
    #     if len(p) == 2:
    #         p[0] = p[1]
    #     elif len(p) == 5:
