...
_lr_action_items = {
    ...
    "DOMAIN_PKEY": ([16,], [30,]),
    "STRIPS_KEY": ([20, 36, 37, 38, 39, 40, 41,], [37, 37, -20, -21, -22, -23, -24,]),
    "EQUALITY_KEY": ([20, 36, 37, 38, 39, 40, 41,], [38, 38, -20, -21, -22, -23, -24,]),
    "TYPING_KEY": ([20, 36, 37, 38, 39, 40, 41,], [39, 39, -20, -21, -22, -23, -24,]),
    "ADL_KEY": ([20, 36, 37, 38, 39, 40, 41,], [40, 40, -20, -21, -22, -23, -24,]),
    "ND_KEY": ([20, 36, 37, 38, 39, 40, 41,], [41, 41, -20, -21, -22, -23, -24,]),
    "TYPES_KEY": ([23,], [46,]),
    "OBJECTS_KEY": ([31,], [53,]),
    ...
    "PRECONDITION_KEY": ([61, 108, 136,], [84, -48, -47,]),
    "HYPHEN": (
        [73, 74, 75, 81, 82, 90, 95, 103,],
        [94, -41, -100, 102, -98, -100, -40, -97,],
    ),
    "GOAL_KEY": ([77,], [99,]),
    "AND_KEY": (
        [
...
_lr_goto_items = {
    ...
    "typed_constants_lst": ([53, 66, 112,], [72, 88, 137,]),
    "constants_lst": ([53, 66, 74, 112, 115,], [73, 73, 95, 73, 140,]),
    "constant": ([53, 66, 74, 112, 115,], [74, 74, 74, 74, 74,]),
    "goal_def": ([55,], [78,]),
    "typed_variables_lst": (
        [58, 85, 121, 166, 167, 195, 196, 209,],
        [79, 107, 143, 202, 203, 226, 227, 235,],
    ),
    "variables_lst": (
        [58, 82, 85, 121, 134, 158, 166, 167, 177, 195, 196, 209,],
        [81, 103, 81, 81, 168, 197, 81, 81, 212, 81, 81, 81,],
    ),
    "precond_def": ([61,], [83,]),
    "ground_predicates_lst": ([76, 98, 114, 141,], [97, 117, 138, 172,]),
    "ground_predicate": ([76, 98, 99, 114, 141,], [98, 98, 120, 98, 98,]),
    "effects_def": ([83,], [104,]),
    "type": ([94, 102,], [112, 121,]),
    "formula": (
        [
    ...
    "one_eff_formula": ([123, 147, 181,], [145, 181, 181,]),
    "formula_lst": ([127, 128, 151, 152, 162,], [161, 163, 188, 189, 200,]),
    "one_eff_formula_lst": ([147, 181,], [180, 214,]),
    "atomic_eff_lst": ([148, 173, 183,], [182, 207, 215,]),
    "atomic_eff": (
        [148, 173, 183, 187, 208, 240, 248, 260,],
        [183, 183, 183, 220, 234, 250, 254, 261,],
    ),
    "literal_lst": ([185, 217, 218,], [216, 237, 239,]),
}
...
_lr_productions = [
    ...
    (
        "goal_def -> LPAREN GOAL_KEY ground_predicate RPAREN",
        "goal_def",
        4,
        "p_goal_def",
        "parser.py",
    ...
    ("require_key -> STRIPS_KEY", "require_key", 1, "p_require_key", "parser.py", 106),
    (
    ...
    ("require_key -> TYPING_KEY", "require_key", 1, "p_require_key", "parser.py", 108),
    ("require_key -> ADL_KEY", "require_key", 1, "p_require_key", "parser.py", 109),
    ("require_key -> ND_KEY", "require_key", 1, "p_require_key", "parser.py", 110),
    (
    ...
    ("names_lst -> NAME names_lst", "names_lst", 2, "p_names_lst", "parser.py", 130),
    ("names_lst -> NAME", "names_lst", 1, "p_names_lst", "parser.py", 131),
    (
    ...
    ("formula -> literal", "formula", 1, "p_formula", "parser.py", 216),
    ("formula -> AND_KEY formula_lst", "formula", 2, "p_formula", "parser.py", 217),
    ("formula -> OR_KEY formula_lst", "formula", 2, "p_formula", "parser.py", 218),
    ("formula -> NOT_KEY formula", "formula", 2, "p_formula", "parser.py", 219),
    (
    ...
    ("formula -> LPAREN literal RPAREN", "formula", 3, "p_formula", "parser.py", 227),
    (
    ...
    ("formula_lst -> formula", "formula_lst", 1, "p_formula_lst", "parser.py", 266),
    (
    ...
    ("atomic_eff -> literal", "atomic_eff", 1, "p_atomic_eff", "parser.py", 338),
    (
    ...
    ("literal_lst -> literal", "literal_lst", 1, "p_literal_lst", "parser.py", 362),
    (
    ...
    ("literal -> predicate", "literal", 1, "p_literal", "parser.py", 370),
    (
    ...
    ("predicate -> NAME", "predicate", 1, "p_predicate", "parser.py", 382),
    (
    ...
    ("type -> NAME", "type", 1, "p_type", "parser.py", 414),
    ("constant -> NAME", "constant", 1, "p_constant", "parser.py", 418),
]
